$(document).ready(function(){
    ...
    $("div#menu h1").css({"padding-left": "0", "float": "none", "margin": "0"});
    ...
    $("div#two ul p.name").css({"float": "left", "font-size":".9em"});
    $("div#two ul p.price").css({"float": "right"});
    $("div#two ul div.description").css({"clear": "both", "color":"#ccc", "line-height":".9em", "font-size":".8em"});
    $("div#two li").css({"margin-left": "55px"});
    $("div#two ul li").css({"margin-bottom": "4px"});


    $("div.course ul > li").css({"margin-bottom": "6px", "clear": "both"});
    $("div.course ul").find("ul >li").css({"margin-bottom": "0", "font-size":".9em"});
    $("div.course ul").find("ul").css({"margin-bottom": "6px"});

    $("div.course ul > li.need_margin").css({"margin-left": "61px", "font-size":".9em"});
